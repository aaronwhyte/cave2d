...
Test44Page.prototype = new Page();
Test44Page.prototype.constructor = Test44Page;

Test44Page.prototype.enterDoc = function() {
 ...
 */
Test44Page.prototype.unlockIosSound = function() {
  this.sfx.sound(0, 0, 0, 0.001, 0, 0, 0.001, 1, 1, 'sine');
  this.iosSoundUnlocked++;
};

Test44Page.prototype.exitDoc = function() {
  if (!this.canvas || !this.pauseMenuDiv) {
...
Test44Page.prototype.refreshPauseMenu = function() {
  var df = document.createDocumentFragment();
  var e;

  e = Dom.ce('div', df, 'gameTitle');
  e.innerHTML = Strings.textToHtml('test 44');
...
Test44Page.prototype.onShaderTextChange = function(vertexShaderText, fragmentShaderText) {
  if (!this.canvas) {
  ...
  this.screen = new Test44PlayScreen(this, this.canvas, this.renderer, Stamps.create(this.renderer), this.sfx);
...
Test44Page.prototype.requestAnimation = function() {
  if (!this.animationId) {
    this.animationId = requestAnimationFrame(this.animateFrameFn, this.canvas);
  }
};

Test44Page.prototype.animateFrame = function(startTimeMs) {
  if (!this.animationId) {
    return;
  }
  if (!this.canvas) {
...
Test44Page.prototype.requestFullScreen = function() {
