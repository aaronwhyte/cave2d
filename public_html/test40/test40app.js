 ...
 * @constructor
 */
function Test40App(vertexShaderPath, fragmentShaderPath) {
  this.gameTitle = 'Test 40';
 ...
 */
Test40App.prototype.start = function() {
  ...
  self.page = new Test40Page(self.gameTitle);
  self.page.enterDoc();
  self.maybeForwardShaderTexts();
};
 ...
 */
Test40App.prototype.maybeForwardShaderTexts = function() {
...
Test40App.prototype.getVertexShaderText = function() {
  return this.shaderTextLoader.getTextByPath(this.vertexShaderPath);
};

Test40App.prototype.getFragmentShaderText = function() {
  return this.shaderTextLoader.getTextByPath(this.fragmentShaderPath);
};

Test40App.prototype.getBeforeUnloadFunction = function() {
  var self = this;
  return function(e) {
    if (self.page) {
