...
class DistGrid {
   ...
   */
  setXY(x, y, nearPixelX, nearPixelY) {
 ...
 */
class DistPixel {
  constructor(pixelX, pixelY, nearPixelX, nearPixelY, pixelDist) {
   ...
   * @param pixelDist
   */
  setXYXYD(pixelX, pixelY, nearPixelX, nearPixelY, pixelDist) {
    this.pixelX = pixelX;
    this.pixelY = pixelY;
