...
Test42Page.prototype = new Page();
Test42Page.prototype.constructor = Test42Page;

Test42Page.prototype.enterDoc = function() {
 ...
 */
Test42Page.prototype.unlockIosSound = function() {
  this.sfx.sound(0, 0, 0, 0.001, 0, 0, 0.001, 1, 1, 'sine');
  this.iosSoundUnlocked++;
};

Test42Page.prototype.exitDoc = function() {
  if (!this.canvas || !this.pauseMenuDiv) {
...
Test42Page.prototype.refreshPauseMenu = function() {
  var df = document.createDocumentFragment();
  var e;

  e = Dom.ce('div', df, 'gameTitle');
  e.innerHTML = Strings.textToHtml('test 42');
...
Test42Page.prototype.onShaderTextChange = function(vertexShaderText, fragmentShaderText) {
  if (!this.canvas) {
  ...
  this.screen = new Test42PlayScreen(this, this.canvas, this.renderer, Stamps.create(this.renderer), this.sfx);
...
Test42Page.prototype.requestAnimation = function() {
  if (!this.animationId) {
    this.animationId = requestAnimationFrame(this.animateFrameFn, this.canvas);
  }
};

Test42Page.prototype.animateFrame = function(startTimeMs) {
  if (!this.animationId) {
    return;
  }
  if (!this.canvas) {
...
Test42Page.prototype.requestFullScreen = function() {
