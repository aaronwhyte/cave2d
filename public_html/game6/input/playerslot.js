/**
 * Game6 object that keeps track of slot state and turns listeners on and off for state transitions.
...
PlayerSlot.prototype.updateViewCircle = function(now) {
  ...
  this.circle.rad = Game6PlayScreen.PLAYER_VIEW_RADIUS;
  ...
  if (!this.spirit) {
    ...
    this.circle.rad *=
        (1 - Game6PlayScreen.STARTING_VIEW_FRACTION) * Math.sin(spawnFraction * Math.PI /2) +
