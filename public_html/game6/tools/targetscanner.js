 ...
 * @override
 */
TargetScanner.prototype.setButtonDown = function(b) {
...
TargetScanner.prototype.doWideScan = function(pos) {
 ...
 */
TargetScanner.prototype.doLockedScan = function() {
...
TargetScanner.prototype.setLockedSpiritId = function(spiritId) {
  this.lockedHitSpiritId = spiritId;
};

TargetScanner.prototype.clearLockedSpiritId = function() {
  this.lockedHitSpiritId = 0;
};
