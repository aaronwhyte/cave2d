...
TitleScreen.prototype.initWorld = function() {
  ...
  // TITLE
  buttonMaker.setLetterColor([0.25*0.7, 0.75*0.7, 1*0.7]).setBlockColor(null).setScale(1);
  buttonMaker.addButton(0, 5, "TEST 33", null);
  buttonMaker.addButton(0, 0, "CURSOR", null);
  ...
  spiritId = buttonMaker.addButton(0, -8, "START", function(e) {
    ...
    controller.gotoScreen(Test33.SCREEN_PLAY);
