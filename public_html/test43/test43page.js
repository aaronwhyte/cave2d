...
Test43Page.prototype = new Page();
Test43Page.prototype.constructor = Test43Page;

Test43Page.prototype.enterDoc = function() {
 ...
 */
Test43Page.prototype.unlockIosSound = function() {
  this.sfx.sound(0, 0, 0, 0.001, 0, 0, 0.001, 1, 1, 'sine');
  this.iosSoundUnlocked++;
};

Test43Page.prototype.exitDoc = function() {
  if (!this.canvas || !this.pauseMenuDiv) {
...
Test43Page.prototype.refreshPauseMenu = function() {
  var df = document.createDocumentFragment();
  var e;

  e = Dom.ce('div', df, 'gameTitle');
  e.innerHTML = Strings.textToHtml('test 43');
...
Test43Page.prototype.onShaderTextChange = function(vertexShaderText, fragmentShaderText) {
  if (!this.canvas) {
  ...
  this.screen = new Test43PlayScreen(this, this.canvas, this.renderer, Stamps.create(this.renderer), this.sfx);
...
Test43Page.prototype.requestAnimation = function() {
  if (!this.animationId) {
    this.animationId = requestAnimationFrame(this.animateFrameFn, this.canvas);
  }
};

Test43Page.prototype.animateFrame = function(startTimeMs) {
  if (!this.animationId) {
    return;
  }
  if (!this.canvas) {
...
Test43Page.prototype.requestFullScreen = function() {
